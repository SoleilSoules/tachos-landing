...
export const reviews = deepNbsp({
  ...
  items: [
    ...
    },
    {
      ...
      author: 'Полина Никонова',
      role: 'Продакт-директор, Хайс',
      text: 'Собрали мобильный банк для ИП с нуля: счёт, бухгалтерия и валюта в одном приложении. Ровно как мы задумывали',
      logo: '/logos/hais-mono.svg',
    },
    {
      id: 'r5',
...
export const posts: Post[] = deepNbsp<Post[]>([
  {
    ...
    body: [
      ...
      {
        type: 'p',
        text: 'Лёгкий веб-стек без тяжёлых зависимостей: игра открывается мгновенно и держит пиковую нагрузку кампании. Отдельно вылизали мобильные браузеры — основной трафик промо приходит с телефонов',
      },
      {
        type: 'quote',
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: 'p',
        text: 'Перед стартом разбираем задачу на этапы и считаем каждый. Прозрачная смета без «звёздочек», а если что-то меняется по ходу — фиксируем изменение отдельно, а не задним числом',
      },
      {
        type: 'p',
